<h2> 1247 61
2357. Make Array Zero by Subtracting Equal Amounts</h2><hr><div bis_skin_checked="1"><p>You are given a non-negative integer array <code>nums</code>. In one operation, you must:</p>
